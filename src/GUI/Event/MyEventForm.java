 ...
 * @author Linab
 */
public class MyEventForm extends Form {
    

    Container block1 = new Container(new BorderLayout());
    Form f = new Form();
    
    public MyEventForm(Resources resourceObjectInstance,int id_user) throws IOException {
        ...
        for (Iterator<Evenement> iterator = event.getListMesEvennements(id_user).iterator(); iterator.hasNext();) {
            Evenement prodnext = iterator.next();
            //initGuiBuilderComponents(resourceObjectInstance);
            blockMyEvent(resourceObjectInstance, prodnext);
        }
        ...
        fab.addActionListener(e -> {
         ...
         public void blockMyEvent(Resources resourceObjectInstance,Evenement p) throws IOException {
