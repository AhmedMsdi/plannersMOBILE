...
//            });
           ...
           // int maxZoom = cnt.getMaxZoom(); 
            ...
            FloatingActionButton btniteneraire = FloatingActionButton.createFAB(FontImage.MATERIAL_ADD_LOCATION);
            btniteneraire.addActionListener(e -> {
                //path 
                Coord src2 = new Coord(36.813280, 10.168338);
                ...
                getRoutesEncodedAsync(src2, destint, new Callback() {
                    @Override
               ...
               Button btnClearAll = new Button("back");
        btnClearAll.addActionListener(e->{
             AjouterPlanForm mp=new AjouterPlanForm(); 
            mp.getF().showBack();
        });
            ...
            Container root = LayeredLayout.encloseIn(
                    ...
                    BorderLayout.south(
                            FlowLayout.encloseBottom(btniteneraire)
                    )
            );
